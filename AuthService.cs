...
public static class AuthService
{
    ...
    public static async Task<(bool ok, string error)> SignInAsync(string email, string password)
    {
        try
        {
            ...
            // Mise à jour last_login + app_version dans la table profiles
        ...
        string email, string password)
    {
        try
        {
            ...
            // Si confirmation email désactivée dans Supabase → accès direct
    ...
    /// <summary>Écrit last_login et app_version dans la table profiles.</summary>
    ...
    /// <summary>Retourne le plan de l'utilisateur ('free', 'beta', 'pro') ou null si erreur.</summary>
